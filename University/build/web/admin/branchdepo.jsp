...
<html>
    ...
    <body>
        ...
        <div class="stu">
            ...
            <div class="common">
                <p><b>Branch Department Information - </b></p>
                <form method="post" action="branchdepo.jsp" name="form">
            ...
            <div class="table">
                ...
                <table>
                    ...
                    <tbody>
                        ...
                        <% 
                            if (!search.equals("")) {
                                query = "Select * from Branch_Department "
                                        + "where BD_ID='"+search+"'";
                            }
                            else {
                                query = "select * from Branch_Department";
                            ...
                            while (rs.next())
                            {
                                ...
                                b_id = rs.getString("BRANCHID");
                                d_id = rs.getString("DEPTID");
