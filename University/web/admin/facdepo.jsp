...
<html>
    ...
    <body>
        ...
        <div class="stu">
            ...
            <div class="common">
                <p><b>Faculty Department Information - </b></p>
                <form method="post" action="facdepo.jsp" name="form">
            ...
            <div class="table">
                ...
                <table>
                    ...
                    <tbody>
                        ...
                        <% 
                            if (!search.equals("")) {
                                query = "Select * from Faculty_Department "
                                        + "where FD_ID='"+search+"'";
                            }
                            else {
                                query = "select * from Faculty_Department";
